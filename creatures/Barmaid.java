...
public class Barmaid extends Actor implements java.io.Serializable {
    ...
    public void startDialogue() {
        ...
        while (true) {
            switch (dialogue.printDialogueReturnNext(this.getName())) {
                case 1 -> {
                    ...
                    dialogue.add("*You look down at your mud caked clothes.*\n" +
                            ...
                            "Is there perhaps some place where I could wash up?'", 4);
                    dialogue.add("'Just give me a beer.'", 2);
                }
                case 2 -> {
                    dialogue = new Dialogue("'Yes, ofcourse.'\n" +
                            "*The barmaid reaches for a glass and fills it up with foamy goodness.*\n" +
                ...
                case 12 -> {
                    dialogue = new Dialogue("'Hmmm. Well, I do have a basement. I don't know if there " +
                            "are any rats down there, but it sure needs some cleaning.\n" +
                            "Tell you what, you clean my basement, and I'll give you that beer for free.'");
                    dialogue.add("'Uhh... that's not the kind of job I had in mind, but sure, I'll do it.'", 13);
                    dialogue.add("'You kow what, keep the beer.'", 6);
                }
                case 13 -> {
                    dialogue = new Dialogue("'That's great! There's really not much of value down there. " +
                            "Whatever you find, you keep.\n" +
                            "The rest you can throw out on the lawn.");
                    dialogue.add("'On the lawn? That's kinda crazy, but you've got yourself a deal, lady.'", 14);
                ...
                case 15 -> {
                    ...
                    dialogue.add("'What's the matter? Did you wake up with a bad case of... ugly face?\n" +
                            "Because that's what you've got. An ugly face.'", 17);
